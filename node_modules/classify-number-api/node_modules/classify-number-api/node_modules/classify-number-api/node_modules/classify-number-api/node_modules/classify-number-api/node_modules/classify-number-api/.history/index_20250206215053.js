...
app.get('/', (req, res) => {
    res.send(`
        <h1>Hi I am Tomola Oke, TM Oke</h1><h1>Welcome to My Number Classification API!</h1>
        ...
        <p>Example: <a href="https://hngx-stage1node-number-classifier.onrender.com/api/classify-number?number=371">Click here to classify the number 371</a></p>
